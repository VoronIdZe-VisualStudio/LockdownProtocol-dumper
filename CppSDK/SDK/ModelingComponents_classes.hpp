...
static_assert(sizeof(UBaseMeshProcessingTool) == 0x000470, "Wrong size on UBaseMeshProcessingTool");
static_assert(offsetof(UBaseMeshProcessingTool, Preview) == 0x000138, "Member 'UBaseMeshProcessingTool::Preview' has a wrong offset!");
...
static_assert(alignof(UMultiTargetWithSelectionToolBuilder) == 0x000008, "Wrong alignment on UMultiTargetWithSelectionToolBuilder");
static_assert(sizeof(UMultiTargetWithSelectionToolBuilder) == 0x000028, "Wrong size on UMultiTargetWithSelectionToolBuilder");
...
static_assert(alignof(UMultiTargetWithSelectionTool) == 0x000008, "Wrong alignment on UMultiTargetWithSelectionTool");
static_assert(sizeof(UMultiTargetWithSelectionTool) == 0x0000E8, "Wrong size on UMultiTargetWithSelectionTool");
static_assert(offsetof(UMultiTargetWithSelectionTool, TargetWorld) == 0x0000B0, "Member 'UMultiTargetWithSelectionTool::TargetWorld' has a wrong offset!");
static_assert(offsetof(UMultiTargetWithSelectionTool, GeometrySelectionVizProperties) == 0x0000D8, "Member 'UMultiTargetWithSelectionTool::GeometrySelectionVizProperties' has a wrong offset!");
static_assert(offsetof(UMultiTargetWithSelectionTool, GeometrySelectionViz) == 0x0000E0, "Member 'UMultiTargetWithSelectionTool::GeometrySelectionViz' has a wrong offset!");
...
{
public:
	uint8                                         Pad_580[0x60];                                     // 0x0580(0x0060)(Fixing Size After Last Property [ Dumper-7 ])
	class UDynamicMesh*                           MeshObject;                                        // 0x05E0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UOctreeDynamicMeshComponent) == 0x0006A0, "Wrong size on UOctreeDynamicMeshComponent");
static_assert(offsetof(UOctreeDynamicMeshComponent, MeshObject) == 0x0005E0, "Member 'UOctreeDynamicMeshComponent::MeshObject' has a wrong offset!");
...
{
public:
	class UMaterialInterface*                     LineMaterial;                                      // 0x0518(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FBoxSphereBounds                       Bounds;                                            // 0x0520(0x0038)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
	bool                                          bBoundsDirty;                                      // 0x0558(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_559[0x47];                                     // 0x0559(0x0047)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ULineSetComponent) == 0x0005A0, "Wrong size on ULineSetComponent");
static_assert(offsetof(ULineSetComponent, LineMaterial) == 0x000518, "Member 'ULineSetComponent::LineMaterial' has a wrong offset!");
static_assert(offsetof(ULineSetComponent, Bounds) == 0x000520, "Member 'ULineSetComponent::Bounds' has a wrong offset!");
static_assert(offsetof(ULineSetComponent, bBoundsDirty) == 0x000558, "Member 'ULineSetComponent::bBoundsDirty' has a wrong offset!");
...
{
public:
	float                                         LineDepthBias;                                     // 0x0518(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LineDepthBiasSizeScale;                            // 0x051C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ThicknessScale;                                    // 0x0520(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableWireframe;                                  // 0x0524(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_525[0x3];                                      // 0x0525(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FColor                                 WireframeColor;                                    // 0x0528(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         WireframeThickness;                                // 0x052C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableBoundaryEdges;                              // 0x0530(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_531[0x3];                                      // 0x0531(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FColor                                 BoundaryEdgeColor;                                 // 0x0534(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         BoundaryEdgeThickness;                             // 0x0538(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableUVSeams;                                    // 0x053C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_53D[0x3];                                      // 0x053D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FColor                                 UVSeamColor;                                       // 0x0540(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         UVSeamThickness;                                   // 0x0544(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableNormalSeams;                                // 0x0548(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_549[0x3];                                      // 0x0549(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FColor                                 NormalSeamColor;                                   // 0x054C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         NormalSeamThickness;                               // 0x0550(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableTangentSeams;                               // 0x0554(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_555[0x3];                                      // 0x0555(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FColor                                 TangentSeamColor;                                  // 0x0558(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TangentSeamThickness;                              // 0x055C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableColorSeams;                                 // 0x0560(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_561[0x3];                                      // 0x0561(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FColor                                 ColorSeamColor;                                    // 0x0564(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ColorSeamThickness;                                // 0x0568(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMeshWireframeComponent) == 0x0005C0, "Wrong size on UMeshWireframeComponent");
static_assert(offsetof(UMeshWireframeComponent, LineDepthBias) == 0x000518, "Member 'UMeshWireframeComponent::LineDepthBias' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, LineDepthBiasSizeScale) == 0x00051C, "Member 'UMeshWireframeComponent::LineDepthBiasSizeScale' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, ThicknessScale) == 0x000520, "Member 'UMeshWireframeComponent::ThicknessScale' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, bEnableWireframe) == 0x000524, "Member 'UMeshWireframeComponent::bEnableWireframe' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, WireframeColor) == 0x000528, "Member 'UMeshWireframeComponent::WireframeColor' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, WireframeThickness) == 0x00052C, "Member 'UMeshWireframeComponent::WireframeThickness' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, bEnableBoundaryEdges) == 0x000530, "Member 'UMeshWireframeComponent::bEnableBoundaryEdges' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, BoundaryEdgeColor) == 0x000534, "Member 'UMeshWireframeComponent::BoundaryEdgeColor' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, BoundaryEdgeThickness) == 0x000538, "Member 'UMeshWireframeComponent::BoundaryEdgeThickness' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, bEnableUVSeams) == 0x00053C, "Member 'UMeshWireframeComponent::bEnableUVSeams' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, UVSeamColor) == 0x000540, "Member 'UMeshWireframeComponent::UVSeamColor' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, UVSeamThickness) == 0x000544, "Member 'UMeshWireframeComponent::UVSeamThickness' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, bEnableNormalSeams) == 0x000548, "Member 'UMeshWireframeComponent::bEnableNormalSeams' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, NormalSeamColor) == 0x00054C, "Member 'UMeshWireframeComponent::NormalSeamColor' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, NormalSeamThickness) == 0x000550, "Member 'UMeshWireframeComponent::NormalSeamThickness' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, bEnableTangentSeams) == 0x000554, "Member 'UMeshWireframeComponent::bEnableTangentSeams' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, TangentSeamColor) == 0x000558, "Member 'UMeshWireframeComponent::TangentSeamColor' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, TangentSeamThickness) == 0x00055C, "Member 'UMeshWireframeComponent::TangentSeamThickness' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, bEnableColorSeams) == 0x000560, "Member 'UMeshWireframeComponent::bEnableColorSeams' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, ColorSeamColor) == 0x000564, "Member 'UMeshWireframeComponent::ColorSeamColor' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, ColorSeamThickness) == 0x000568, "Member 'UMeshWireframeComponent::ColorSeamThickness' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, LineMaterial) == 0x000570, "Member 'UMeshWireframeComponent::LineMaterial' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, LocalBounds) == 0x000578, "Member 'UMeshWireframeComponent::LocalBounds' has a wrong offset!");
...
{
public:
	class UMaterialInterface*                     PointMaterial;                                     // 0x0518(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FBoxSphereBounds                       Bounds;                                            // 0x0520(0x0038)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
	bool                                          bBoundsDirty;                                      // 0x0558(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_559[0x47];                                     // 0x0559(0x0047)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPointSetComponent) == 0x0005A0, "Wrong size on UPointSetComponent");
static_assert(offsetof(UPointSetComponent, PointMaterial) == 0x000518, "Member 'UPointSetComponent::PointMaterial' has a wrong offset!");
static_assert(offsetof(UPointSetComponent, Bounds) == 0x000520, "Member 'UPointSetComponent::Bounds' has a wrong offset!");
static_assert(offsetof(UPointSetComponent, bBoundsDirty) == 0x000558, "Member 'UPointSetComponent::bBoundsDirty' has a wrong offset!");
...
{
public:
	struct FBoxSphereBounds                       Bounds;                                            // 0x0518(0x0038)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
	bool                                          bBoundsDirty;                                      // 0x0550(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UTriangleSetComponent) == 0x000620, "Wrong size on UTriangleSetComponent");
static_assert(offsetof(UTriangleSetComponent, Bounds) == 0x000518, "Member 'UTriangleSetComponent::Bounds' has a wrong offset!");
static_assert(offsetof(UTriangleSetComponent, bBoundsDirty) == 0x000550, "Member 'UTriangleSetComponent::bBoundsDirty' has a wrong offset!");
...
static_assert(sizeof(UPlaneDistanceFromHitMechanic) == 0x000530, "Wrong size on UPlaneDistanceFromHitMechanic");
...
static_assert(sizeof(UGeometrySelectionManager) == 0x0004C0, "Wrong size on UGeometrySelectionManager");
...
static_assert(offsetof(UGeometrySelectionManager, PreviewGeometry) == 0x000140, "Member 'UGeometrySelectionManager::PreviewGeometry' has a wrong offset!");
static_assert(offsetof(UGeometrySelectionManager, UnselectedParams) == 0x0002C0, "Member 'UGeometrySelectionManager::UnselectedParams' has a wrong offset!");
static_assert(offsetof(UGeometrySelectionManager, HoverOverSelectedParams) == 0x000308, "Member 'UGeometrySelectionManager::HoverOverSelectedParams' has a wrong offset!");
static_assert(offsetof(UGeometrySelectionManager, HoverOverUnselectedParams) == 0x000350, "Member 'UGeometrySelectionManager::HoverOverUnselectedParams' has a wrong offset!");
static_assert(offsetof(UGeometrySelectionManager, SelectedParams) == 0x000398, "Member 'UGeometrySelectionManager::SelectedParams' has a wrong offset!");
