...
static_assert(sizeof(ANavigationData) == 0x000500, "Wrong size on ANavigationData");
...
static_assert(sizeof(AAbstractNavData) == 0x000500, "Wrong size on AAbstractNavData");
...
static_assert(sizeof(ANavigationGraph) == 0x000500, "Wrong size on ANavigationGraph");
...
static_assert(sizeof(ANavigationTestingActor) == 0x000400, "Wrong size on ANavigationTestingActor");
...
static_assert(offsetof(ANavigationTestingActor, QueryTargetActor) == 0x000350, "Member 'ANavigationTestingActor::QueryTargetActor' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, RadiusUsedToValidateNavData) == 0x00035C, "Member 'ANavigationTestingActor::RadiusUsedToValidateNavData' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, CostDisplayMode) == 0x000360, "Member 'ANavigationTestingActor::CostDisplayMode' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, TextCanvasOffset) == 0x000368, "Member 'ANavigationTestingActor::TextCanvasOffset' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, PathfindingTime) == 0x00037C, "Member 'ANavigationTestingActor::PathfindingTime' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, PathCost) == 0x000380, "Member 'ANavigationTestingActor::PathCost' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, PathfindingSteps) == 0x000388, "Member 'ANavigationTestingActor::PathfindingSteps' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, OtherActor) == 0x000390, "Member 'ANavigationTestingActor::OtherActor' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, FilterClass) == 0x000398, "Member 'ANavigationTestingActor::FilterClass' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, ShowStepIndex) == 0x0003A0, "Member 'ANavigationTestingActor::ShowStepIndex' has a wrong offset!");
static_assert(offsetof(ANavigationTestingActor, OffsetFromCornersDistance) == 0x0003A4, "Member 'ANavigationTestingActor::OffsetFromCornersDistance' has a wrong offset!");
...
static_assert(sizeof(UNavMeshRenderingComponent) == 0x000550, "Wrong size on UNavMeshRenderingComponent");
...
static_assert(sizeof(ARecastNavMesh) == 0x000780, "Wrong size on ARecastNavMesh");
static_assert(offsetof(ARecastNavMesh, DrawOffset) == 0x000504, "Member 'ARecastNavMesh::DrawOffset' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, TileGenerationDebug) == 0x000508, "Member 'ARecastNavMesh::TileGenerationDebug' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, TilePoolSize) == 0x000530, "Member 'ARecastNavMesh::TilePoolSize' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, TileSizeUU) == 0x000534, "Member 'ARecastNavMesh::TileSizeUU' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, CellSize) == 0x000538, "Member 'ARecastNavMesh::CellSize' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, CellHeight) == 0x00053C, "Member 'ARecastNavMesh::CellHeight' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, AgentMaxStepHeight) == 0x000540, "Member 'ARecastNavMesh::AgentMaxStepHeight' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, NavMeshResolutionParams) == 0x000544, "Member 'ARecastNavMesh::NavMeshResolutionParams' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, AgentRadius) == 0x000568, "Member 'ARecastNavMesh::AgentRadius' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, AgentHeight) == 0x00056C, "Member 'ARecastNavMesh::AgentHeight' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, AgentMaxSlope) == 0x000570, "Member 'ARecastNavMesh::AgentMaxSlope' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, MinRegionArea) == 0x000574, "Member 'ARecastNavMesh::MinRegionArea' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, MergeRegionSize) == 0x000578, "Member 'ARecastNavMesh::MergeRegionSize' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, MaxVerticalMergeError) == 0x00057C, "Member 'ARecastNavMesh::MaxVerticalMergeError' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, MaxSimplificationError) == 0x000580, "Member 'ARecastNavMesh::MaxSimplificationError' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, SimplificationElevationRatio) == 0x000584, "Member 'ARecastNavMesh::SimplificationElevationRatio' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, MaxSimultaneousTileGenerationJobsCount) == 0x000588, "Member 'ARecastNavMesh::MaxSimultaneousTileGenerationJobsCount' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, TileNumberHardLimit) == 0x00058C, "Member 'ARecastNavMesh::TileNumberHardLimit' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, PolyRefTileBits) == 0x000590, "Member 'ARecastNavMesh::PolyRefTileBits' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, PolyRefNavPolyBits) == 0x000594, "Member 'ARecastNavMesh::PolyRefNavPolyBits' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, PolyRefSaltBits) == 0x000598, "Member 'ARecastNavMesh::PolyRefSaltBits' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, NavMeshOriginOffset) == 0x0005A0, "Member 'ARecastNavMesh::NavMeshOriginOffset' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, DefaultDrawDistance) == 0x0005B8, "Member 'ARecastNavMesh::DefaultDrawDistance' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, DefaultMaxSearchNodes) == 0x0005BC, "Member 'ARecastNavMesh::DefaultMaxSearchNodes' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, DefaultMaxHierarchicalSearchNodes) == 0x0005C0, "Member 'ARecastNavMesh::DefaultMaxHierarchicalSearchNodes' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, LedgeSlopeFilterMode) == 0x0005C4, "Member 'ARecastNavMesh::LedgeSlopeFilterMode' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, RegionPartitioning) == 0x0005C5, "Member 'ARecastNavMesh::RegionPartitioning' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, LayerPartitioning) == 0x0005C6, "Member 'ARecastNavMesh::LayerPartitioning' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, RegionChunkSplits) == 0x0005C8, "Member 'ARecastNavMesh::RegionChunkSplits' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, LayerChunkSplits) == 0x0005CC, "Member 'ARecastNavMesh::LayerChunkSplits' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, TimeSliceFilterLedgeSpansMaxYProcess) == 0x0005D4, "Member 'ARecastNavMesh::TimeSliceFilterLedgeSpansMaxYProcess' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, TimeSliceLongDurationDebug) == 0x0005D8, "Member 'ARecastNavMesh::TimeSliceLongDurationDebug' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, InvokerTilePriorityBumpDistanceThresholdInTileUnits) == 0x0005E0, "Member 'ARecastNavMesh::InvokerTilePriorityBumpDistanceThresholdInTileUnits' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, InvokerTilePriorityBumpIncrease) == 0x0005E4, "Member 'ARecastNavMesh::InvokerTilePriorityBumpIncrease' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, NavLinkJumpDownConfig) == 0x0005E8, "Member 'ARecastNavMesh::NavLinkJumpDownConfig' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, TileSetUpdateInterval) == 0x000640, "Member 'ARecastNavMesh::TileSetUpdateInterval' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, HeuristicScale) == 0x000644, "Member 'ARecastNavMesh::HeuristicScale' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, VerticalDeviationFromGroundCompensation) == 0x000648, "Member 'ARecastNavMesh::VerticalDeviationFromGroundCompensation' has a wrong offset!");
...
static_assert(offsetof(UNavModifierComponent, AreaClassToReplace) == 0x0000F8, "Member 'UNavModifierComponent::AreaClassToReplace' has a wrong offset!");
...
static_assert(offsetof(ANavModifierVolume, AreaClassToReplace) == 0x0002F0, "Member 'ANavModifierVolume::AreaClassToReplace' has a wrong offset!");
...
static_assert(offsetof(ANavModifierVolume, NavMeshResolution) == 0x0002F9, "Member 'ANavModifierVolume::NavMeshResolution' has a wrong offset!");
