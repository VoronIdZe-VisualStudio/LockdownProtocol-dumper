...
static_assert(alignof(FDatasmithTessellationOptions) == 0x000008, "Wrong alignment on FDatasmithTessellationOptions");
static_assert(sizeof(FDatasmithTessellationOptions) == 0x000020, "Wrong size on FDatasmithTessellationOptions");
...
static_assert(offsetof(FDatasmithTessellationOptions, GeometricTolerance) == 0x000010, "Member 'FDatasmithTessellationOptions::GeometricTolerance' has a wrong offset!");
static_assert(offsetof(FDatasmithTessellationOptions, StitchingTolerance) == 0x000018, "Member 'FDatasmithTessellationOptions::StitchingTolerance' has a wrong offset!");
...
static_assert(alignof(FDatasmithRetessellationOptions) == 0x000008, "Wrong alignment on FDatasmithRetessellationOptions");
static_assert(sizeof(FDatasmithRetessellationOptions) == 0x000028, "Wrong size on FDatasmithRetessellationOptions");
static_assert(offsetof(FDatasmithRetessellationOptions, RetessellationRule) == 0x000020, "Member 'FDatasmithRetessellationOptions::RetessellationRule' has a wrong offset!");
