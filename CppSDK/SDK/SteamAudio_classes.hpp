...
static_assert(sizeof(USteamAudioSourceComponent) == 0x000128, "Wrong size on USteamAudioSourceComponent");
...
static_assert(offsetof(USteamAudioSourceComponent, bPathValidation) == 0x000100, "Member 'USteamAudioSourceComponent::bPathValidation' has a wrong offset!");
static_assert(offsetof(USteamAudioSourceComponent, bFindAlternatePaths) == 0x000101, "Member 'USteamAudioSourceComponent::bFindAlternatePaths' has a wrong offset!");
