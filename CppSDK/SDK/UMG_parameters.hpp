...
static_assert(alignof(ListView_SetScrollBarPadding) == 0x000004, "Wrong alignment on ListView_SetScrollBarPadding");
static_assert(sizeof(ListView_SetScrollBarPadding) == 0x000010, "Wrong size on ListView_SetScrollBarPadding");
static_assert(offsetof(ListView_SetScrollBarPadding, InScrollBarPadding) == 0x000000, "Member 'ListView_SetScrollBarPadding::InScrollBarPadding' has a wrong offset!");
...
static_assert(alignof(ListView_GetScrollBarPadding) == 0x000004, "Wrong alignment on ListView_GetScrollBarPadding");
static_assert(sizeof(ListView_GetScrollBarPadding) == 0x000010, "Wrong size on ListView_GetScrollBarPadding");
static_assert(offsetof(ListView_GetScrollBarPadding, ReturnValue) == 0x000000, "Member 'ListView_GetScrollBarPadding::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(WidgetInteractionComponent_SetCustomHitResult) == 0x000100, "Wrong size on WidgetInteractionComponent_SetCustomHitResult");
...
static_assert(sizeof(WidgetInteractionComponent_GetLastHitResult) == 0x000100, "Wrong size on WidgetInteractionComponent_GetLastHitResult");
