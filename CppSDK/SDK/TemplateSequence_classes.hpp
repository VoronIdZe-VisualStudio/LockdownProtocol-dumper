...
static_assert(sizeof(ATemplateSequenceActor) == 0x000310, "Wrong size on ATemplateSequenceActor");
...
static_assert(offsetof(ATemplateSequenceActor, SequencePlayer) == 0x0002D8, "Member 'ATemplateSequenceActor::SequencePlayer' has a wrong offset!");
static_assert(offsetof(ATemplateSequenceActor, TemplateSequence) == 0x0002E0, "Member 'ATemplateSequenceActor::TemplateSequence' has a wrong offset!");
static_assert(offsetof(ATemplateSequenceActor, BindingOverride) == 0x000300, "Member 'ATemplateSequenceActor::BindingOverride' has a wrong offset!");
