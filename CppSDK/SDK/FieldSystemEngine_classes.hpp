...
{
public:
	class UFieldSystem*                           FieldSystem;                                       // 0x04E8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, AdvancedDisplay, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsWorldField;                                     // 0x04F0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsChaosField;                                     // 0x04F1(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FFieldObjectCommands                   ConstructionCommands;                              // 0x0508(0x0030)(ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FFieldObjectCommands                   BufferCommands;                                    // 0x0538(0x0030)(ContainsInstancedReference, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UFieldSystemComponent) == 0x0005C0, "Wrong size on UFieldSystemComponent");
...
static_assert(offsetof(UFieldSystemComponent, bIsWorldField) == 0x0004F0, "Member 'UFieldSystemComponent::bIsWorldField' has a wrong offset!");
static_assert(offsetof(UFieldSystemComponent, bIsChaosField) == 0x0004F1, "Member 'UFieldSystemComponent::bIsChaosField' has a wrong offset!");
...
static_assert(offsetof(UFieldSystemComponent, ConstructionCommands) == 0x000508, "Member 'UFieldSystemComponent::ConstructionCommands' has a wrong offset!");
static_assert(offsetof(UFieldSystemComponent, BufferCommands) == 0x000538, "Member 'UFieldSystemComponent::BufferCommands' has a wrong offset!");
