...
static_assert(sizeof(UOffsetMeshTool) == 0x000490, "Wrong size on UOffsetMeshTool");
static_assert(offsetof(UOffsetMeshTool, OffsetProperties) == 0x000470, "Member 'UOffsetMeshTool::OffsetProperties' has a wrong offset!");
static_assert(offsetof(UOffsetMeshTool, IterativeProperties) == 0x000478, "Member 'UOffsetMeshTool::IterativeProperties' has a wrong offset!");
static_assert(offsetof(UOffsetMeshTool, ImplicitProperties) == 0x000480, "Member 'UOffsetMeshTool::ImplicitProperties' has a wrong offset!");
static_assert(offsetof(UOffsetMeshTool, WeightMapProperties) == 0x000488, "Member 'UOffsetMeshTool::WeightMapProperties' has a wrong offset!");
...
public:
	...
	class UBakeUVShellMapToolProperties*          UVShellSettings;                                   // 0x0338(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UBakeMeshAttributeMapsTool) == 0x0003D8, "Wrong size on UBakeMeshAttributeMapsTool");
...
static_assert(offsetof(UBakeMeshAttributeMapsTool, UVShellSettings) == 0x000338, "Member 'UBakeMeshAttributeMapsTool::UVShellSettings' has a wrong offset!");
...
static_assert(sizeof(UBakeMeshAttributeVertexTool) == 0x0002B0, "Wrong size on UBakeMeshAttributeVertexTool");
...
static_assert(sizeof(UDisplaceMeshTool) == 0x0004D0, "Wrong size on UDisplaceMeshTool");
...
static_assert(offsetof(UDisplaceMeshTool, PreviewMeshActor) == 0x0004A8, "Member 'UDisplaceMeshTool::PreviewMeshActor' has a wrong offset!");
static_assert(offsetof(UDisplaceMeshTool, DynamicMeshComponent) == 0x0004B0, "Member 'UDisplaceMeshTool::DynamicMeshComponent' has a wrong offset!");
...
{
public:
	class UPreviewMesh*                           PreviewMesh;                                       // 0x02A0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UDynamicMeshBrushTool) == 0x0002E8, "Wrong size on UDynamicMeshBrushTool");
static_assert(offsetof(UDynamicMeshBrushTool, PreviewMesh) == 0x0002A0, "Member 'UDynamicMeshBrushTool::PreviewMesh' has a wrong offset!");
...
public:
	...
	class USeamSculptToolProperties*              Settings;                                          // 0x02F0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPreviewGeometry*                       PreviewGeom;                                       // 0x02F8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(USeamSculptTool, Settings) == 0x0002F0, "Member 'USeamSculptTool::Settings' has a wrong offset!");
static_assert(offsetof(USeamSculptTool, PreviewGeom) == 0x0002F8, "Member 'USeamSculptTool::PreviewGeom' has a wrong offset!");
...
public:
	...
	class ULatticeControlPointsMechanic*          ControlPointsMechanic;                             // 0x0180(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class ULatticeDeformerToolProperties*         Settings;                                          // 0x0188(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMeshOpPreviewWithBackgroundCompute*    Preview;                                           // 0x0190(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(alignof(ULatticeDeformerTool) == 0x000010, "Wrong alignment on ULatticeDeformerTool");
static_assert(sizeof(ULatticeDeformerTool) == 0x000210, "Wrong size on ULatticeDeformerTool");
static_assert(offsetof(ULatticeDeformerTool, ControlPointsMechanic) == 0x000180, "Member 'ULatticeDeformerTool::ControlPointsMechanic' has a wrong offset!");
static_assert(offsetof(ULatticeDeformerTool, Settings) == 0x000188, "Member 'ULatticeDeformerTool::Settings' has a wrong offset!");
static_assert(offsetof(ULatticeDeformerTool, Preview) == 0x000190, "Member 'ULatticeDeformerTool::Preview' has a wrong offset!");
static_assert(offsetof(ULatticeDeformerTool, bLatticeDeformed) == 0x000198, "Member 'ULatticeDeformerTool::bLatticeDeformed' has a wrong offset!");
...
public:
	uint8                                         Pad_2E8[0x8];                                      // 0x02E8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UMeshAttributePaintBrushOperationProperties* BrushActionProps;                             // 0x02F0(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMeshAttributePaintToolProperties*      AttribProps;                                       // 0x02F8(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_300[0x510];                                    // 0x0300(0x0510)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMeshAttributePaintTool) == 0x000810, "Wrong size on UMeshAttributePaintTool");
static_assert(offsetof(UMeshAttributePaintTool, BrushActionProps) == 0x0002F0, "Member 'UMeshAttributePaintTool::BrushActionProps' has a wrong offset!");
static_assert(offsetof(UMeshAttributePaintTool, AttribProps) == 0x0002F8, "Member 'UMeshAttributePaintTool::AttribProps' has a wrong offset!");
...
// 0x0458 (0x0740 - 0x02E8)
class UMeshSelectionTool final : public UDynamicMeshBrushTool
{
public:
	uint8                                         Pad_2E8[0x8];                                      // 0x02E8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UMeshSelectionToolProperties*           SelectionProps;                                    // 0x02F0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMeshSelectionEditActions*              SelectionActions;                                  // 0x02F8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMeshSelectionToolActionPropertySet*    EditActions;                                       // 0x0300(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMeshStatisticsProperties*              MeshStatisticsProperties;                          // 0x0308(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMeshElementsVisualizer*                MeshElementsDisplay;                               // 0x0310(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMeshUVChannelProperties*               UVChannelProperties;                               // 0x0318(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPolygroupLayersProperties*             PolygroupLayerProperties;                          // 0x0320(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_328[0x58];                                     // 0x0328(0x0058)(Fixing Size After Last Property [ Dumper-7 ])
	class UMeshSelectionSet*                      Selection;                                         // 0x0380(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class AActor*>                         SpawnedActors;                                     // 0x0388(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                         Pad_398[0x3A8];                                    // 0x0398(0x03A8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMeshSelectionTool) == 0x000740, "Wrong size on UMeshSelectionTool");
static_assert(offsetof(UMeshSelectionTool, SelectionProps) == 0x0002F0, "Member 'UMeshSelectionTool::SelectionProps' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, SelectionActions) == 0x0002F8, "Member 'UMeshSelectionTool::SelectionActions' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, EditActions) == 0x000300, "Member 'UMeshSelectionTool::EditActions' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, MeshStatisticsProperties) == 0x000308, "Member 'UMeshSelectionTool::MeshStatisticsProperties' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, MeshElementsDisplay) == 0x000310, "Member 'UMeshSelectionTool::MeshElementsDisplay' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, UVChannelProperties) == 0x000318, "Member 'UMeshSelectionTool::UVChannelProperties' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, PolygroupLayerProperties) == 0x000320, "Member 'UMeshSelectionTool::PolygroupLayerProperties' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, Selection) == 0x000380, "Member 'UMeshSelectionTool::Selection' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, SpawnedActors) == 0x000388, "Member 'UMeshSelectionTool::SpawnedActors' has a wrong offset!");
...
static_assert(sizeof(USmoothMeshTool) == 0x0004A0, "Wrong size on USmoothMeshTool");
static_assert(offsetof(USmoothMeshTool, SmoothProperties) == 0x000478, "Member 'USmoothMeshTool::SmoothProperties' has a wrong offset!");
static_assert(offsetof(USmoothMeshTool, IterativeProperties) == 0x000480, "Member 'USmoothMeshTool::IterativeProperties' has a wrong offset!");
static_assert(offsetof(USmoothMeshTool, DiffusionProperties) == 0x000488, "Member 'USmoothMeshTool::DiffusionProperties' has a wrong offset!");
static_assert(offsetof(USmoothMeshTool, ImplicitProperties) == 0x000490, "Member 'USmoothMeshTool::ImplicitProperties' has a wrong offset!");
static_assert(offsetof(USmoothMeshTool, WeightMapProperties) == 0x000498, "Member 'USmoothMeshTool::WeightMapProperties' has a wrong offset!");
