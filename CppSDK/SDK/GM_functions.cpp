...
// TArray<Enum_SelectedColor>*             Available_Colors                                       (Parm, OutParm)

void AGM_C::Switch_Player_Color(class AMec_C* Mec, Enum_SelectedColor Color, bool* Available, class AMec_C** Owner_0, TArray<Enum_SelectedColor>* Available_Colors)
{
	static class UFunction* Func = nullptr;
	...
	if (Available_Colors != nullptr)
		*Available_Colors = std::move(Parms.Available_Colors);
}
