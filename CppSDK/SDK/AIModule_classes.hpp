...
static_assert(offsetof(UAIDataProvider_Random, min_0) == 0x000040, "Member 'UAIDataProvider_Random::min_0' has a wrong offset!");
static_assert(offsetof(UAIDataProvider_Random, max_0) == 0x000044, "Member 'UAIDataProvider_Random::max_0' has a wrong offset!");
...
public:
	...
	class ANavigationData*                        MyNavData;                                         // 0x0100(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_108[0x1E8];                                    // 0x0108(0x01E8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPathFollowingComponent) == 0x0002F0, "Wrong size on UPathFollowingComponent");
...
public:
	...
	struct FVector                                CrowdAgentMoveDirection;                           // 0x0308(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UCrowdFollowingComponent) == 0x000340, "Wrong size on UCrowdFollowingComponent");
static_assert(offsetof(UCrowdFollowingComponent, CrowdAgentMoveDirection) == 0x000308, "Member 'UCrowdFollowingComponent::CrowdAgentMoveDirection' has a wrong offset!");
...
{
public:
	class UNavLocalGridManager*                   GridManager;                                       // 0x02F0(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UGridPathFollowingComponent) == 0x000320, "Wrong size on UGridPathFollowingComponent");
static_assert(offsetof(UGridPathFollowingComponent, GridManager) == 0x0002F0, "Member 'UGridPathFollowingComponent::GridManager' has a wrong offset!");
