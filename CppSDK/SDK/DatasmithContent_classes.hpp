...
static_assert(sizeof(ADatasmithAreaLightActor) == 0x000320, "Wrong size on ADatasmithAreaLightActor");
static_assert(offsetof(ADatasmithAreaLightActor, Mobility) == 0x0002A8, "Member 'ADatasmithAreaLightActor::Mobility' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, LightType) == 0x0002A9, "Member 'ADatasmithAreaLightActor::LightType' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, LightShape) == 0x0002AA, "Member 'ADatasmithAreaLightActor::LightShape' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, Dimensions) == 0x0002B0, "Member 'ADatasmithAreaLightActor::Dimensions' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, Intensity) == 0x0002C0, "Member 'ADatasmithAreaLightActor::Intensity' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, IntensityUnits) == 0x0002C4, "Member 'ADatasmithAreaLightActor::IntensityUnits' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, Color) == 0x0002C8, "Member 'ADatasmithAreaLightActor::Color' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, Temperature) == 0x0002D8, "Member 'ADatasmithAreaLightActor::Temperature' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, IESTexture) == 0x0002E0, "Member 'ADatasmithAreaLightActor::IESTexture' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, bUseIESBrightness) == 0x0002E8, "Member 'ADatasmithAreaLightActor::bUseIESBrightness' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, IESBrightnessScale) == 0x0002EC, "Member 'ADatasmithAreaLightActor::IESBrightnessScale' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, Rotation) == 0x0002F0, "Member 'ADatasmithAreaLightActor::Rotation' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, SourceRadius) == 0x000308, "Member 'ADatasmithAreaLightActor::SourceRadius' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, SourceLength) == 0x00030C, "Member 'ADatasmithAreaLightActor::SourceLength' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, AttenuationRadius) == 0x000310, "Member 'ADatasmithAreaLightActor::AttenuationRadius' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, SpotlightInnerAngle) == 0x000314, "Member 'ADatasmithAreaLightActor::SpotlightInnerAngle' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, SpotlightOuterAngle) == 0x000318, "Member 'ADatasmithAreaLightActor::SpotlightOuterAngle' has a wrong offset!");
...
static_assert(sizeof(ADatasmithImportedSequencesActor) == 0x0002B8, "Wrong size on ADatasmithImportedSequencesActor");
static_assert(offsetof(ADatasmithImportedSequencesActor, ImportedSequences) == 0x0002A8, "Member 'ADatasmithImportedSequencesActor::ImportedSequences' has a wrong offset!");
...
static_assert(sizeof(UDatasmithCommonTessellationOptions) == 0x000048, "Wrong size on UDatasmithCommonTessellationOptions");
...
static_assert(sizeof(ADatasmithSceneActor) == 0x000300, "Wrong size on ADatasmithSceneActor");
static_assert(offsetof(ADatasmithSceneActor, Scene) == 0x0002A8, "Member 'ADatasmithSceneActor::Scene' has a wrong offset!");
static_assert(offsetof(ADatasmithSceneActor, RelatedActors) == 0x0002B0, "Member 'ADatasmithSceneActor::RelatedActors' has a wrong offset!");
