...
static_assert(alignof(GeometryCollectionBlueprintLibrary_SetCustomInstanceDataByIndex) == 0x000008, "Wrong alignment on GeometryCollectionBlueprintLibrary_SetCustomInstanceDataByIndex");
static_assert(sizeof(GeometryCollectionBlueprintLibrary_SetCustomInstanceDataByIndex) == 0x000010, "Wrong size on GeometryCollectionBlueprintLibrary_SetCustomInstanceDataByIndex");
static_assert(offsetof(GeometryCollectionBlueprintLibrary_SetCustomInstanceDataByIndex, GeometryCollectionComponent) == 0x000000, "Member 'GeometryCollectionBlueprintLibrary_SetCustomInstanceDataByIndex::GeometryCollectionComponent' has a wrong offset!");
static_assert(offsetof(GeometryCollectionBlueprintLibrary_SetCustomInstanceDataByIndex, CustomDataIndex) == 0x000008, "Member 'GeometryCollectionBlueprintLibrary_SetCustomInstanceDataByIndex::CustomDataIndex' has a wrong offset!");
static_assert(offsetof(GeometryCollectionBlueprintLibrary_SetCustomInstanceDataByIndex, CustomDataValue) == 0x00000C, "Member 'GeometryCollectionBlueprintLibrary_SetCustomInstanceDataByIndex::CustomDataValue' has a wrong offset!");
...
static_assert(alignof(GeometryCollectionBlueprintLibrary_SetCustomInstanceDataByName) == 0x000008, "Wrong alignment on GeometryCollectionBlueprintLibrary_SetCustomInstanceDataByName");
static_assert(sizeof(GeometryCollectionBlueprintLibrary_SetCustomInstanceDataByName) == 0x000018, "Wrong size on GeometryCollectionBlueprintLibrary_SetCustomInstanceDataByName");
static_assert(offsetof(GeometryCollectionBlueprintLibrary_SetCustomInstanceDataByName, GeometryCollectionComponent) == 0x000000, "Member 'GeometryCollectionBlueprintLibrary_SetCustomInstanceDataByName::GeometryCollectionComponent' has a wrong offset!");
static_assert(offsetof(GeometryCollectionBlueprintLibrary_SetCustomInstanceDataByName, CustomDataName) == 0x000008, "Member 'GeometryCollectionBlueprintLibrary_SetCustomInstanceDataByName::CustomDataName' has a wrong offset!");
static_assert(offsetof(GeometryCollectionBlueprintLibrary_SetCustomInstanceDataByName, CustomDataValue) == 0x000010, "Member 'GeometryCollectionBlueprintLibrary_SetCustomInstanceDataByName::CustomDataValue' has a wrong offset!");
...
static_assert(sizeof(GeometryCollectionActor_RaycastSingle) == 0x000138, "Wrong size on GeometryCollectionActor_RaycastSingle");
...
static_assert(offsetof(GeometryCollectionActor_RaycastSingle, ReturnValue) == 0x000130, "Member 'GeometryCollectionActor_RaycastSingle::ReturnValue' has a wrong offset!");
...
static_assert(alignof(GeometryCollectionComponent_ForceBrokenForCustomRenderer) == 0x000001, "Wrong alignment on GeometryCollectionComponent_ForceBrokenForCustomRenderer");
...
static_assert(offsetof(GeometryCollectionComponent_ForceBrokenForCustomRenderer, bForceBroken) == 0x000000, "Member 'GeometryCollectionComponent_ForceBrokenForCustomRenderer::bForceBroken' has a wrong offset!");
...
static_assert(alignof(GeometryCollectionComponent_SetRootProxyComponentSpaceTransform) == 0x000010, "Wrong alignment on GeometryCollectionComponent_SetRootProxyComponentSpaceTransform");
static_assert(sizeof(GeometryCollectionComponent_SetRootProxyComponentSpaceTransform) == 0x000070, "Wrong size on GeometryCollectionComponent_SetRootProxyComponentSpaceTransform");
static_assert(offsetof(GeometryCollectionComponent_SetRootProxyComponentSpaceTransform, Index_0) == 0x000000, "Member 'GeometryCollectionComponent_SetRootProxyComponentSpaceTransform::Index_0' has a wrong offset!");
static_assert(offsetof(GeometryCollectionComponent_SetRootProxyComponentSpaceTransform, RootProxyTransform) == 0x000010, "Member 'GeometryCollectionComponent_SetRootProxyComponentSpaceTransform::RootProxyTransform' has a wrong offset!");
...
static_assert(alignof(GeometryCollectionComponent_SetSolverActor) == 0x000008, "Wrong alignment on GeometryCollectionComponent_SetSolverActor");
...
static_assert(offsetof(GeometryCollectionComponent_SetSolverActor, InSolverActor) == 0x000000, "Member 'GeometryCollectionComponent_SetSolverActor::InSolverActor' has a wrong offset!");
...
static_assert(alignof(GeometryCollectionComponent_GetLocalRestTransforms) == 0x000008, "Wrong alignment on GeometryCollectionComponent_GetLocalRestTransforms");
static_assert(sizeof(GeometryCollectionComponent_GetLocalRestTransforms) == 0x000018, "Wrong size on GeometryCollectionComponent_GetLocalRestTransforms");
static_assert(offsetof(GeometryCollectionComponent_GetLocalRestTransforms, bInitialTransforms) == 0x000000, "Member 'GeometryCollectionComponent_GetLocalRestTransforms::bInitialTransforms' has a wrong offset!");
static_assert(offsetof(GeometryCollectionComponent_GetLocalRestTransforms, ReturnValue) == 0x000008, "Member 'GeometryCollectionComponent_GetLocalRestTransforms::ReturnValue' has a wrong offset!");
...
static_assert(alignof(GeometryCollectionComponent_GetSolverActor) == 0x000008, "Wrong alignment on GeometryCollectionComponent_GetSolverActor");
static_assert(sizeof(GeometryCollectionComponent_GetSolverActor) == 0x000008, "Wrong size on GeometryCollectionComponent_GetSolverActor");
static_assert(offsetof(GeometryCollectionComponent_GetSolverActor, ReturnValue) == 0x000000, "Member 'GeometryCollectionComponent_GetSolverActor::ReturnValue' has a wrong offset!");
