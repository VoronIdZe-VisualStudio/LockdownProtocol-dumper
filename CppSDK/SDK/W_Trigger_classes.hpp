...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"W_Trigger_C">();
	}
...
static_assert(alignof(UW_Trigger_C) == 0x000008, "Wrong alignment on UW_Trigger_C");
static_assert(sizeof(UW_Trigger_C) == 0x000360, "Wrong size on UW_Trigger_C");
static_assert(offsetof(UW_Trigger_C, UberGraphFrame) == 0x0002D0, "Member 'UW_Trigger_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UW_Trigger_C, ShowBackground) == 0x0002D8, "Member 'UW_Trigger_C::ShowBackground' has a wrong offset!");
static_assert(offsetof(UW_Trigger_C, Background) == 0x0002E0, "Member 'UW_Trigger_C::Background' has a wrong offset!");
static_assert(offsetof(UW_Trigger_C, Hovered) == 0x0002E8, "Member 'UW_Trigger_C::Hovered' has a wrong offset!");
static_assert(offsetof(UW_Trigger_C, On_Pressed) == 0x0002F0, "Member 'UW_Trigger_C::On_Pressed' has a wrong offset!");
static_assert(offsetof(UW_Trigger_C, Menu) == 0x000300, "Member 'UW_Trigger_C::Menu' has a wrong offset!");
static_assert(offsetof(UW_Trigger_C, On_Released) == 0x000308, "Member 'UW_Trigger_C::On_Released' has a wrong offset!");
static_assert(offsetof(UW_Trigger_C, Hold_Tick) == 0x000318, "Member 'UW_Trigger_C::Hold_Tick' has a wrong offset!");
static_assert(offsetof(UW_Trigger_C, Last_Hovered) == 0x000328, "Member 'UW_Trigger_C::Last_Hovered' has a wrong offset!");
static_assert(offsetof(UW_Trigger_C, On_Enter) == 0x000330, "Member 'UW_Trigger_C::On_Enter' has a wrong offset!");
static_assert(offsetof(UW_Trigger_C, On_Leave) == 0x000340, "Member 'UW_Trigger_C::On_Leave' has a wrong offset!");
static_assert(offsetof(UW_Trigger_C, Can_Hold) == 0x000350, "Member 'UW_Trigger_C::Can_Hold' has a wrong offset!");
static_assert(offsetof(UW_Trigger_C, Hold) == 0x000351, "Member 'UW_Trigger_C::Hold' has a wrong offset!");
static_assert(offsetof(UW_Trigger_C, Debug) == 0x000352, "Member 'UW_Trigger_C::Debug' has a wrong offset!");
static_assert(offsetof(UW_Trigger_C, Sound) == 0x000353, "Member 'UW_Trigger_C::Sound' has a wrong offset!");
static_assert(offsetof(UW_Trigger_C, Active) == 0x000354, "Member 'UW_Trigger_C::Active' has a wrong offset!");
static_assert(offsetof(UW_Trigger_C, PC_Ref) == 0x000358, "Member 'UW_Trigger_C::PC_Ref' has a wrong offset!");
