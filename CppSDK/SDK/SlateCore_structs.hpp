...
static_assert(sizeof(FToolBarStyle) == 0x003660, "Wrong size on FToolBarStyle");
...
static_assert(offsetof(FToolBarStyle, SettingsButtonStyle) == 0x002010, "Member 'FToolBarStyle::SettingsButtonStyle' has a wrong offset!");
...
static_assert(offsetof(FToolBarStyle, SettingsToggleButton) == 0x0028C0, "Member 'FToolBarStyle::SettingsToggleButton' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, ButtonStyle) == 0x003210, "Member 'FToolBarStyle::ButtonStyle' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, LabelPadding) == 0x003580, "Member 'FToolBarStyle::LabelPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, UniformBlockWidth) == 0x003590, "Member 'FToolBarStyle::UniformBlockWidth' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, UniformBlockHeight) == 0x003594, "Member 'FToolBarStyle::UniformBlockHeight' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, NumColumns) == 0x003598, "Member 'FToolBarStyle::NumColumns' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, IconPadding) == 0x00359C, "Member 'FToolBarStyle::IconPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, SeparatorPadding) == 0x0035AC, "Member 'FToolBarStyle::SeparatorPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, SeparatorThickness) == 0x0035BC, "Member 'FToolBarStyle::SeparatorThickness' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, ComboButtonPadding) == 0x0035C0, "Member 'FToolBarStyle::ComboButtonPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, ButtonPadding) == 0x0035D0, "Member 'FToolBarStyle::ButtonPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, CheckBoxPadding) == 0x0035E0, "Member 'FToolBarStyle::CheckBoxPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, BlockPadding) == 0x0035F0, "Member 'FToolBarStyle::BlockPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, IndentedBlockPadding) == 0x003600, "Member 'FToolBarStyle::IndentedBlockPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, BackgroundPadding) == 0x003610, "Member 'FToolBarStyle::BackgroundPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, IconSize) == 0x003620, "Member 'FToolBarStyle::IconSize' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, bShowLabels) == 0x003628, "Member 'FToolBarStyle::bShowLabels' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, ButtonContentMaxWidth) == 0x00362C, "Member 'FToolBarStyle::ButtonContentMaxWidth' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, ButtonContentFillWidth) == 0x003630, "Member 'FToolBarStyle::ButtonContentFillWidth' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, IconPaddingWithVisibleLabel) == 0x003634, "Member 'FToolBarStyle::IconPaddingWithVisibleLabel' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, IconPaddingWithCollapsedLabel) == 0x003644, "Member 'FToolBarStyle::IconPaddingWithCollapsedLabel' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, VerticalAlignmentOverride) == 0x003654, "Member 'FToolBarStyle::VerticalAlignmentOverride' has a wrong offset!");
