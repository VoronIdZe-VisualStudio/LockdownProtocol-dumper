...
{
public:
	class UNiagaraSystem*                         Asset;                                             // 0x04E8(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	int32                                         RandomSeedOffset;                                  // 0x04F4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FNiagaraUserRedirectionParameterStore  OverrideParameters;                                // 0x04F8(0x00D8)(NativeAccessSpecifierPrivate)
	uint8                                         BitPad_5D0_0 : 1;                                  // 0x05D0(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	uint8                                         bEnableGpuComputeDebug : 1;                        // 0x05D0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bOverrideWarmupSettings : 1;                       // 0x05D0(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_5D1[0x3];                                      // 0x05D1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         WarmupTickCount;                                   // 0x05D4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         WarmupTickDelta;                                   // 0x05D8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_5DC[0x34];                                     // 0x05DC(0x0034)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         bAutoManageAttachment : 1;                         // 0x0610(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAutoAttachWeldSimulatedBodies : 1;                // 0x0610(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_611[0x3];                                      // 0x0611(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MaxTimeBeforeForceUpdateTransform;                 // 0x0614(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_618[0x1];                                      // 0x0618(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	ENiagaraOcclusionQueryMode                    OcclusionQueryMode;                                // 0x0619(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_61A[0x6];                                      // 0x061A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void(class UNiagaraComponent* PSystem)> OnSystemFinished;               // 0x0620(0x0010)(ZeroConstructor, InstancedReference, DuplicateTransient, BlueprintAssignable, NativeAccessSpecifierPublic)
	TWeakObjectPtr<class USceneComponent>         AutoAttachParent;                                  // 0x0630(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, DisableEditOnTemplate, EditConst, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   AutoAttachSocketName;                              // 0x0638(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachmentRule                               AutoAttachLocationRule;                            // 0x0640(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachmentRule                               AutoAttachRotationRule;                            // 0x0641(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachmentRule                               AutoAttachScaleRule;                               // 0x0642(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_643[0x9];                                      // 0x0643(0x0009)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         BitPad_64C_0 : 4;                                  // 0x064C(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	uint8                                         bAllowScalability : 1;                             // 0x064C(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_64D[0xEB];                                     // 0x064D(0x00EB)(Fixing Size After Last Property [ Dumper-7 ])
	class UNiagaraSimCache*                       SimCache;                                          // 0x0738(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UNiagaraCullProxyComponent*             CullProxy;                                         // 0x0740(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UNiagaraComponent) == 0x000750, "Wrong size on UNiagaraComponent");
...
static_assert(offsetof(UNiagaraComponent, RandomSeedOffset) == 0x0004F4, "Member 'UNiagaraComponent::RandomSeedOffset' has a wrong offset!");
...
static_assert(offsetof(UNiagaraComponent, WarmupTickCount) == 0x0005D4, "Member 'UNiagaraComponent::WarmupTickCount' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, WarmupTickDelta) == 0x0005D8, "Member 'UNiagaraComponent::WarmupTickDelta' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, MaxTimeBeforeForceUpdateTransform) == 0x000614, "Member 'UNiagaraComponent::MaxTimeBeforeForceUpdateTransform' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, OcclusionQueryMode) == 0x000619, "Member 'UNiagaraComponent::OcclusionQueryMode' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, OnSystemFinished) == 0x000620, "Member 'UNiagaraComponent::OnSystemFinished' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachParent) == 0x000630, "Member 'UNiagaraComponent::AutoAttachParent' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachSocketName) == 0x000638, "Member 'UNiagaraComponent::AutoAttachSocketName' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachLocationRule) == 0x000640, "Member 'UNiagaraComponent::AutoAttachLocationRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachRotationRule) == 0x000641, "Member 'UNiagaraComponent::AutoAttachRotationRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachScaleRule) == 0x000642, "Member 'UNiagaraComponent::AutoAttachScaleRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, SimCache) == 0x000738, "Member 'UNiagaraComponent::SimCache' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, CullProxy) == 0x000740, "Member 'UNiagaraComponent::CullProxy' has a wrong offset!");
...
{
public:
	TArray<struct FNiagaraCulledComponentInfo>    Instances;                                         // 0x0748(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraCullProxyComponent) == 0x000760, "Wrong size on UNiagaraCullProxyComponent");
static_assert(offsetof(UNiagaraCullProxyComponent, Instances) == 0x000748, "Member 'UNiagaraCullProxyComponent::Instances' has a wrong offset!");
...
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamInt32, min_0) == 0x000038, "Member 'UNiagaraPreviewAxis_InterpParamInt32::min_0' has a wrong offset!");
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamInt32, max_0) == 0x00003C, "Member 'UNiagaraPreviewAxis_InterpParamInt32::max_0' has a wrong offset!");
...
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamFloat, min_0) == 0x000038, "Member 'UNiagaraPreviewAxis_InterpParamFloat::min_0' has a wrong offset!");
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamFloat, max_0) == 0x00003C, "Member 'UNiagaraPreviewAxis_InterpParamFloat::max_0' has a wrong offset!");
...
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamVector2D, min_0) == 0x000038, "Member 'UNiagaraPreviewAxis_InterpParamVector2D::min_0' has a wrong offset!");
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamVector2D, max_0) == 0x000048, "Member 'UNiagaraPreviewAxis_InterpParamVector2D::max_0' has a wrong offset!");
...
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamVector, min_0) == 0x000038, "Member 'UNiagaraPreviewAxis_InterpParamVector::min_0' has a wrong offset!");
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamVector, max_0) == 0x000050, "Member 'UNiagaraPreviewAxis_InterpParamVector::max_0' has a wrong offset!");
...
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamVector4, min_0) == 0x000040, "Member 'UNiagaraPreviewAxis_InterpParamVector4::min_0' has a wrong offset!");
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamVector4, max_0) == 0x000060, "Member 'UNiagaraPreviewAxis_InterpParamVector4::max_0' has a wrong offset!");
...
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamLinearColor, min_0) == 0x000038, "Member 'UNiagaraPreviewAxis_InterpParamLinearColor::min_0' has a wrong offset!");
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamLinearColor, max_0) == 0x000048, "Member 'UNiagaraPreviewAxis_InterpParamLinearColor::max_0' has a wrong offset!");
