...
namespace Offsets
{
	constexpr int32 GObjects          = 0x087279B0;
	constexpr int32 AppendString      = 0x01225F30;
	constexpr int32 GNames            = 0x08644240;
	constexpr int32 GWorld            = 0x088A4270;
	constexpr int32 ProcessEvent      = 0x0144C4F0;
