...
static_assert(alignof(FSteamCoreAudioInputDeviceInfo) == 0x000008, "Wrong alignment on FSteamCoreAudioInputDeviceInfo");
static_assert(sizeof(FSteamCoreAudioInputDeviceInfo) == 0x000030, "Wrong size on FSteamCoreAudioInputDeviceInfo");
static_assert(offsetof(FSteamCoreAudioInputDeviceInfo, DeviceName) == 0x000000, "Member 'FSteamCoreAudioInputDeviceInfo::DeviceName' has a wrong offset!");
static_assert(offsetof(FSteamCoreAudioInputDeviceInfo, DeviceID) == 0x000010, "Member 'FSteamCoreAudioInputDeviceInfo::DeviceID' has a wrong offset!");
static_assert(offsetof(FSteamCoreAudioInputDeviceInfo, InputChannels) == 0x000020, "Member 'FSteamCoreAudioInputDeviceInfo::InputChannels' has a wrong offset!");
static_assert(offsetof(FSteamCoreAudioInputDeviceInfo, PreferredSampleRate) == 0x000024, "Member 'FSteamCoreAudioInputDeviceInfo::PreferredSampleRate' has a wrong offset!");
